...
class ManagerHistoriSelesai extends StatefulWidget {
  @override
  _BagianManagertState createState() => _BagianManagertState();
}

class _BagianManagertState extends State<ManagerHistoriSelesai> {
  ThemeData themeData;
        ...
        return MaterialApp(
            ...
            home: Scaffold(
                appBar: AppBar(
                  ...
                  centerTitle: true,
                  title: Text("INFO STATUS REQUEST",
                              ...
                              children: <Widget>[
                                ...
                                Padding(
                                  ...
                                  child: TextFormField(
                                    ...
                                    readOnly: true,
                                    controller:
                                        TextEditingController(text: "Selesai"),
                                  ),
                                ),
                              ],
                            ),
