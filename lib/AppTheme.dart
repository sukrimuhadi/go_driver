...
class AppTheme {
  ...
  static final ThemeData lightTheme = ThemeData(
    ...
    navigationRailTheme: NavigationRailThemeData(
        selectedIconTheme:
            IconThemeData(color: Color(0xff1FB4D5), opacity: 1, size: 24),
        unselectedIconTheme:
            IconThemeData(color: Color(0xff495057), opacity: 1, size: 24),
        backgroundColor: Color(0xffffffff),
        elevation: 3,
        selectedLabelTextStyle: TextStyle(color: Color(0xff1FB4D5)),
        unselectedLabelTextStyle: TextStyle(color: Color(0xff495057))),
    colorScheme: ColorScheme.light(
        primary: Color(0xff1A9FBD),
        onPrimary: Colors.white,
        primaryVariant: Color(0xff1FB4D5),
        secondary: Color(0xff495057),
        secondaryVariant: Color(0xffC5F7FF),
        onSecondary: Colors.white,
        surface: Color(0xffe2e7f1),
        background: Color(0xff1A9FBD),
  ...
  static NavigationBarTheme getNavigationThemeFromMode(int themeMode) {
    ...
    if (themeMode == themeLight) {
      ...
      navigationBarTheme.selectedItemColor = Color(0xff1FB4D5);
      navigationBarTheme.unselectedItemColor = Color(0xff495057);
      navigationBarTheme.selectedOverlayColor = Color(0x381FB4D5);
    } else if (themeMode == themeDark) {
